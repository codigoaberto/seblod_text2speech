...
// Plugin
class plgCCK_FieldVozme_Speaker extends JCckPluginField
{
	protected static $type		=	'vozme_speaker';
...
$doc->addScript("http://vozme.com/get_text.js");

		$options2	=	JCckDev::fromJSON( $field->options2 );
		$value ='<a href="javascript:void(0);" onclick="get_id(\'cck1_mainbody\',\''.$options2['vozme_language'].'\',\'ml\');" style="line-height:40px;"><img src="http://vozme.com/img/megaphone40x40w.gif" border="0" style="float:left; margin-right:0.4em;" alt="Hear text"/>'.$options2['vozme_text'].'</a>';
		$field->value	=	$value;
	}
